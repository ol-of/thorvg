    ...
    while (true)
    {
      ...
      switch (scanner_context.mode)
      {
        ...
        case SCAN_MODE_CLASS_BODY_NO_SCAN:
        {
          ...
          private_field_flags = (private_field_flags | lexer_token_is_identifier (context_p, "get", 3) ? SCANNER_PRIVATE_FIELD_GETTER : (scanner_private_field_flags_t) 0);
          private_field_flags = (private_field_flags | lexer_token_is_identifier (context_p, "set", 3) ? SCANNER_PRIVATE_FIELD_SETTER : (scanner_private_field_flags_t) 0);
